...
class Kha4Quick {
    public static function main() {
        //TOD: add antiAlias; 4 ?? 
        System.init({title: "Quick", width: 1024, height: 768, samplesPerPixel: 4 }, new Kha4Quick );
    }
    ...
    public function new(){
        ...
        triangles = [ { ax: -.5, ay: -.5, bx: -.5, by: -.5, cx: 0., cy: 0.36602540378443864676372317075294, 1 } ];
        var mouse = Mouse.get();
